<?php
require_once MODX_CORE_PATH.'model/modx/processors/security/user/delete.class.php';
 ...
 */
class utUserDeleteProcessor extends modUserDeleteProcessor  {
